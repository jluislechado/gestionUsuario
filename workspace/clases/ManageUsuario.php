...
class ManageUsuario {
 private $bd = null;
    ...
    function getListWhere($condicion,$pagina=1, $nrpp=Constant::NRPP){
         ...
         $this->bd->select($this->tabla, "*", $condicion, array(), "alias, email","", $registroInicial, $nrpp);
         $r=array();
    ...
    function getList($proyeccion='*',$orden='email',$criterio='1', $pagina=1, $nrpp=Constant::NRPP){
         $registroInicial = ($pagina-1)*$nrpp;
