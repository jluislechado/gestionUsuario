...
<html>
    ...
    <body>
        ...
        <div id="h1">ÁREA DEL ADMINISTRADOR</div>
        <div class="blanco"></div>
        ...
        <div id="ladoDerecho">
            <div class="usuario">
                <a href="modificarAdmin.php">Modificar mi alias</a>
            </div>
            <div class="usuario">
            ...
            <div class="usuario">
                <a href="alta.php">Dar de alta a un usuario</a>
            </div>
            <div class="usuario">
                <a href="listarUsuarios.php">Listar Usuarios</a>
            </div>
            <div class="usuario">
                <a href="listarTrabajadores.php">Listar Trabajadores</a>
            </div>
            <div class="usuario">
